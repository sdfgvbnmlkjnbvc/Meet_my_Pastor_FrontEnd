...
const SizedBox(height: 10,),
        ...
        SingleChildScrollView(
          child: Container(height: MediaQuery.of(context).size.height*0.45,
            child: StreamBuilder(stream:dataStream.Appointments(context: context), initialData: {"progress":"loading"},
