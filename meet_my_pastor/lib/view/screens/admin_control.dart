              ...
              children: [
                ...
                SingleChildScrollView(
                  child: SizedBox(
                    ...
                    child: StreamBuilder(
                      stream: dataStream.Appointments(context: context),
                      initialData: const {"progress": "loading"},
                      builder: (context, snapshot) {
                        if (snapshot.hasData == true &&
                            dataStream.respData['Appointment'] != null) {
                          // print(
                          //     " ----- checking end ponit data == $dataStream --------  ");
                                    ...
                                    children: [
                                      InkWell(
                                          child: ListTile(
                                            ...
                                            title: Text(appointmentsData[index]
                                                    ['name']
                                                .toString()),
                                            subtitle: Text(
                                              appointmentsData[index]['email']
                                                  .toString(),
                                            ),
                                            trailing: Text(
                                                appointmentsData[index]['time']
                                                    .toString()),
                                          ),
                                          onTap: () {
                                            PageNavigator(ctx: context)
                                                .nextPage(
                                              page: readAppointment(
                                                name: Text(
                                                    ...
                                                    style: const TextStyle(
                                                        ...
                                                        fontWeight:
                                                            FontWeight.bold)),
                                                time: Text(
                                                    "Time: ${appointmentsData[index]['time']}",
                                                    style: const TextStyle(
                                                        fontFamily:
                                                            "Montserrat",
                                                        decoration:
                                                        ...
                                                        fontWeight:
                                                            FontWeight.normal)),
                                                date: Text(
                                                    "Date: ${appointmentsData[index]['Date']} ",
                                                    style: const TextStyle(
                                                        fontFamily:
                                                            "Montserrat",
                                                        color: Colors.black,
